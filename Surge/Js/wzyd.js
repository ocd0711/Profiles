/**************************************
项目名称：王者营地签到
使用说明：点击我/每日福利->手动签到一次，若提示获取ck即可使用，建议开启抓包再签到。
项目作者：@ocd0711

感谢樱花佬的脚本框架@sliverkiss https://t.me/sliverkiss

@Date:2024-07-01 完成脚本
...
**************
[task_local]
30 9 * * * https://raw.githubusercontent.com/ocd0711/Profiles/master/Surge/Js/wzyd.js, tag=王者营地签到, img-url=https://raw.githubusercontent.com/ocd0711/Profiles/wzyd/master/icon/wzyd.png, enabled=true

[rewrite_local]
# 签到
^https:\/\/vip\.ixiliu\.cn\/mp\/sign\/applyV2$ url script-request-body https://raw.githubusercontent.com/ocd0711/Profiles/master/Surge/Js/wzyd.js
#获取ck
^https:\/\/vip\.ixiliu\.cn\/mp\/user\/info$ url script-request-header https://raw.githubusercontent.com/ocd0711/Profiles/master/Surge/Js/wzyd.js
...
class UserInfo {
    constructor(str) {
        ...
        this.msdkEncodeParam = data.msdkEncodeParam;
        this.msdktoken = data.msdktoken;
        this.sig = data.sig;
    ...
    async signin() {
        try {
            const options = {
                ...
                //请求头, 所有接口通用
                headers: {
                    "authority": "kohcamp.qq.com",
                    "timestamp": "1719805636518",
                    "userid": this.userid,
                    "msdkEncodeParam": this.msdkEncodeParam,
                    "gameopenid": "owanlsoFFgwJ62zTj0Mv3m73zUjY",
                    "accept": "application/json, text/plain, */*",
                    "encode": "2",
                    "msdktoken": this.msdktoken,
                    "gameid": "20001",
                    "h5get": "1",
                    "noencrypt": "1",
                    "user-agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 17_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;GameHelper;smobagamehelper,iphoneX",
                    "version": "3.1.96i",
                    "roleid": "325478607",
                    "sec-fetch-site": "same-site",
                    "x-client-proto": "https",
                    "camproleid": "3852236843",
...
async function getCookie() {
    if ($request && $request.method === 'POST') {
        ...
        const msdktoken = $request.headers['msdktoken'];
        const sig = $request.headers['sig'];
        const openid = $request.headers['openid'];
        const token = $request.headers['token'];

        // 检查所有参数是否都存在
        if (userid && msdkEncodeParam && msdktoken && sig && openid && token) {
            // 存储参数到对象中
            const tokenData = {
                userid,
                msdkEncodeParam,
